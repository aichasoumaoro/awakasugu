...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'modifier') {
    ...
    if ($id && $nom && $valeur > 0) {
        try {
            ...
            // Synchronisation manuelle des produits (si un produit est sélectionné)
            if ($produit_id) {
...
<head>
    ...
    <title>Modifier une promotion - Admin Awa Ka Sugu</title>
...
<div class="content">
    <div class="content-header">
        <div>
            <h2><span>✏️</span> Modifier la promotion</h2>
    ...
    <div class="form-container">
        <div class="form-title">
            <i class="bi bi-pencil-square"></i> Informations de la promotion
        </div>
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="mb-3">
                        ...
                        <input type="text" name="nom" class="form-control" value="<?= htmlspecialchars($promo['nom']) ?>" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Description</label>
                        <textarea name="description" class="form-control" rows="2"><?= htmlspecialchars($promo['description'] ?? '') ?></textarea>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input type="checkbox" name="est_active" class="form-check-input" id="active" <?= $promo['est_active'] ? 'checked' : '' ?>>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select name="type" class="form-select">
                            <option value="pourcentage" <?= $promo['type'] == 'pourcentage' ? 'selected' : '' ?>>Pourcentage (%)</option>
                            <option value="montant_fixe" <?= $promo['type'] == 'montant_fixe' ? 'selected' : '' ?>>Montant fixe (FCFA)</option>
                        </select>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" name="valeur" class="form-control" step="1" value="<?= $promo['valeur'] ?>" required>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <select name="produit_id" class="form-select">
                    ...
                    <?php foreach($produits as $p): ?>
                        <option value="<?= $p['id'] ?>" <?= $promo['produit_id'] == $p['id'] ? 'selected' : '' ?>>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="date" name="date_debut" class="form-control" value="<?= $promo['date_debut'] ?>" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">

        ...
        try {
            ...
            $stmt = $pdo->prepare("
                ...
                SET statut = 'en_attente', 
                    ...
                    notes = CONCAT(COALESCE(notes, ''), '\nDépôt Orange Money - Téléphone: ', ?, ' - Nom: ', ?)
                WHERE id = ?
            ");
            ...
            // Stocker le nom du déposant dans notes car pas de colonne dédiée
            $notes = 'Déposant: ' . $nom_deposant;
...
$titre_page = 'Paiement Orange Money - Awa Ka Sugu';
...
<head>
    ...
    <style>
        ...
        .method-icon { background: linear-gradient(135deg, #FF6600, #FF8C00); width: 80px; height: 80px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 20px; }
        ...
        .info-box { background: #FFF9F0; border-left: 4px solid #FF6600; padding: 15px 20px; border-radius: 10px; margin: 20px 0; }
        .info-box i { color: #FF6600; margin-right: 10px; }
        ...
        .btn-payer { background: linear-gradient(135deg, #FF6600, #FF8C00); color: white; border: none; padding: 16px; border-radius: 12px; font-weight: 700; font-size: 1rem; width: 100%; cursor: pointer; transition: all 0.3s; }
        .btn-payer:hover { transform: translateY(-2px); box-shadow: 0 8px 25px rgba(255,102,0,0.3); }
        ...
        .numero-entreprise .numero { font-size: 1.3rem; font-weight: 700; color: #FF6600; letter-spacing: 2px; }
...
<div class="paiement-container">
    <div class="paiement-card">
        ...
        <h2 style="font-family: 'Playfair Display', serif; text-align: center; color: #0D0D0D;">Orange Money</h2>
        ...
        <div class="numero-entreprise">
            ...
            <span style="color:#8A99AA;font-size:0.7rem;">(Orange Money)</span>
        </div>
        ...
        <div class="info-box">
            ...
            <p style="margin:5px 0 0 0;color:#5A6B7A;font-size:0.9rem;">
                Après avoir effectué le dépôt, veuillez remplir le formulaire ci-dessous avec les informations du déposant pour que nous puissions vérifier votre paiement.
            </p>
        </div>
        ...
        <form method="POST">
            ...
            <div class="mb-3">
                ...
                <small class="text-muted" style="font-size:0.7rem;">Le numéro utilisé pour effectuer le dépôt</small>
            </div>
            ...
            <div class="mb-3" style="background:#F5F0EB;border-radius:10px;padding:15px;">
                <div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;">
                    ...
                    <span style="font-size:1.3rem;font-weight:700;color:#FF6600;"><?= number_format($commande['total'], 0, ',', ' ') ?> FCFA</span>
                </div>
            </div>

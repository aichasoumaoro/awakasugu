        ...
        try {
            ...
            $stmt = $pdo->prepare("
                ...
                SET statut = 'en_attente', 
                    ...
                    notes = CONCAT(COALESCE(notes, ''), '\nDépôt Moov Money - Téléphone: ', ?, ' - Nom: ', ?)
                WHERE id = ?
            ");
            $stmt->execute([$telephone_paiement, $nom_deposant, $commande_id]);
            
            $reference = 'MOOV-' . $commande['numero_commande'] . '-' . time();
            ...
            error_log("Erreur paiement Moov Money: " . $e->getMessage());
        }
    }
}

$titre_page = 'Paiement Moov Money - Awa Ka Sugu';
...
<head>
    ...
    <title>Paiement Moov Money - Awa Ka Sugu</title>
    ...
    <style>
        ...
        .method-icon { background: linear-gradient(135deg, #E63E2E, #FF6B5A); width: 80px; height: 80px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 20px; }
        ...
        .info-box { background: #FDF0EE; border-left: 4px solid #E63E2E; padding: 15px 20px; border-radius: 10px; margin: 20px 0; }
        .info-box i { color: #E63E2E; margin-right: 10px; }
        .form-control { border-radius: 10px; padding: 12px 16px; border: 1.5px solid #E8E0D8; font-family: 'Jost', sans-serif; }
        .form-control:focus { border-color: #E63E2E; box-shadow: 0 0 0 3px rgba(230,62,46,0.1); }
        .btn-payer { background: linear-gradient(135deg, #E63E2E, #FF6B5A); color: white; border: none; padding: 16px; border-radius: 12px; font-weight: 700; font-size: 1rem; width: 100%; cursor: pointer; transition: all 0.3s; }
        .btn-payer:hover { transform: translateY(-2px); box-shadow: 0 8px 25px rgba(230,62,46,0.3); }
        ...
        .numero-entreprise .numero { font-size: 1.3rem; font-weight: 700; color: #E63E2E; letter-spacing: 2px; }
...
<div class="paiement-container">
    <div class="paiement-card">
        ...
        <h2 style="font-family: 'Playfair Display', serif; text-align: center; color: #0D0D0D;">Moov Money</h2>
        ...
        <div class="info-box">
            ...
            <p style="margin:5px 0 0 0;color:#5A6B7A;font-size:0.9rem;">
                Après avoir effectué le dépôt sur notre numéro Moov Money, veuillez remplir le formulaire ci-dessous avec les informations du déposant pour que nous puissions vérifier votre paiement.
            </p>
        </div>
        ...
        <form method="POST">
            ...
            <div class="mb-3">
                ...
                <small class="text-muted" style="font-size:0.7rem;">Le numéro utilisé pour effectuer le dépôt Moov Money</small>
            </div>
            ...
            <div class="mb-3" style="background:#F5F0EB;border-radius:10px;padding:15px;">
                <div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;">
                    ...
                    <span style="font-size:1.3rem;font-weight:700;color:#E63E2E;"><?= number_format($commande['total'], 0, ',', ' ') ?> FCFA</span>
                </div>
            </div>
